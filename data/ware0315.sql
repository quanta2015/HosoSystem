...
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (8, 'HOSO-20240312172800', '退货入库', NULL, NULL, 2, 2, 1003, 24, 0, 20, NULL, 'keboda', '2024-03-12 17:28:00');
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (9, 'HOSO-20240312172800', '退货入库', NULL, NULL, 2, 2, 1006, 8, 0, 20, NULL, 'keboda', '2024-03-12 17:28:00');
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (10, 'HOSO-20240312172800', '退货入库', NULL, NULL, 2, 2, 1042, 12, 0, 20, NULL, 'keboda', '2024-03-12 17:28:00');
...
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (18, 'HOSO-20240312174356', '采购入库', NULL, NULL, 1, 3, 1006, 24, 0, 20, NULL, 'keboda', '2024-03-12 17:43:56');
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (19, 'HOSO-20240312174356', '采购入库', NULL, NULL, 1, 3, 1166, 12, 0, 20, NULL, 'keboda', '2024-03-12 17:43:56');
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (20, 'HOSO-20240312174356', '采购入库', NULL, NULL, 1, 3, 1022, 88, 0, 20, NULL, 'keboda', '2024-03-12 17:43:56');
...
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (25, 'HOSO-20240313152540', '銷售出庫', 2, 1, NULL, NULL, 1002, 4, 0, 10, '', 'keboda', '2024-03-13 15:25:40');
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (26, 'HOSO-20240313152540', '銷售出庫', 2, 1, NULL, NULL, 1001, 8, 0, 10, '', 'keboda', '2024-03-13 15:25:40');
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (27, 'HOSO-20240313152540', '銷售出庫', 2, 1, NULL, NULL, 1020, 28, 0, 10, '', 'keboda', '2024-03-13 15:25:40');
...
INSERT INTO `tab_stock_io` (`id`, `recept_code`, `type`, `out_dep_id`, `out_ware_id`, `in_dep_id`, `in_ware_id`, `part_id`, `num`, `status`, `state`, `remark`, `create_name`, `create_time`) VALUES (36, 'HOSO-20240313163448', '社內移動', 2, 1, 1, 4, 1001, 12, 0, 30, NULL, 'keboda', '2024-03-13 16:34:48');
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_stock_io` AS select row_number() OVER (ORDER BY `t`.`recept_code` )  AS `key`,`t`.`recept_code` AS `recept_code`,`t`.`type` AS `type`,`t`.`out_dep_id` AS `out_dep_id`,`t`.`out_ware_id` AS `out_ware_id`,`w1`.`name` AS `out_ware_name`,`t`.`in_dep_id` AS `in_dep_id`,`t`.`in_ware_id` AS `in_ware_id`,`w2`.`name` AS `in_ware_name`,`t`.`state` AS `state`,`t`.`remark` AS `remark`,(case `t`.`state` when 10 then '出庫待審核' when 11 then '待出庫' when 12 then '出庫完成' when 13 then '出庫錯誤' when 14 then '出庫审核未通过' when 20 then '入庫待審核' when 21 then '待入庫' when 22 then '入庫完成' when 23 then '入庫出錯' when 24 then '部分入庫' when 25 then '入庫审核未通过' when 30 then '移动待審核' when 31 then '待移动' when 32 then '移动完成' when 33 then '移动錯誤' when 34 then '移动审核未通过' end) AS `state_text` from (((select `s`.`state` AS `state`,`s`.`recept_code` AS `recept_code`,`s`.`type` AS `type`,`s`.`out_dep_id` AS `out_dep_id`,`s`.`out_ware_id` AS `out_ware_id`,`s`.`in_dep_id` AS `in_dep_id`,`s`.`in_ware_id` AS `in_ware_id`,`s`.`remark` AS `remark` from `tab_stock_io` `s` where (`s`.`status` = 0) group by `s`.`recept_code`,`s`.`type`,`s`.`state`,`s`.`out_dep_id`,`s`.`out_ware_id`,`s`.`in_dep_id`,`s`.`in_ware_id`,`s`.`remark`) `t` left join `tab_ware` `w1` on((`t`.`out_ware_id` = `w1`.`id`))) left join `tab_ware` `w2` on((`t`.`in_ware_id` = `w2`.`id`)));
